...
const ContextManager_1 = __webpack_require__(5);
const FileSystemManager_1 = __webpack_require__(6);
const ModelClient_1 = __webpack_require__(8);
const CodebaseIndexer_1 = __webpack_require__(15);
const InlineCompletionProvider_1 = __webpack_require__(27);
const ChatEnhancer_1 = __webpack_require__(28);
            ...
            switch (action) {
                case 'createFile':
                    ...
                    if (content && filePath.match(/\.(ts|js|tsx|jsx|py|java)$/)) {
                        const { CodeAnalyzer } = await Promise.resolve().then(() => __importStar(__webpack_require__(29)));
...
<body>
    ...
    context.subscriptions.push(openCommand, settingsCommand, indexCommand, toggleAutocompleteCommand, syncFromCloudCommand, syncToCloudCommand, testLiveDBCommand);
...
const LiveDBClient_1 = __webpack_require__(4);
class StorageManager {
    constructor(context) {
        this.context = context;
        this.secretStorage = context.secrets;
        this.liveDB = new LiveDBClient_1.LiveDBClient();
     ...
     */
    getUserId() {
        let userId = this.context.globalState.get('vibeall.userId');
        if (!userId) {
...
class LiveDBClient {
     ...
     */
    async storeAPIKey(provider, key, userId) {
        try {
     ...
     */
    async updateAPIKey(id, provider, key, userId) {
        try {
     ...
     */
    async syncToCloud(apiKeys, userId) {
        try {
...
exports.LiveDBClient = LiveDBClient;
...
const GroqClient_1 = __webpack_require__(9);
const GoogleClient_1 = __webpack_require__(11);
const OpenAIClient_1 = __webpack_require__(12);
const AnthropicClient_1 = __webpack_require__(13);
const BytezClient_1 = __webpack_require__(14);
class ModelClient {
    constructor() {
...
const BaseAPIClient_1 = __webpack_require__(10);
...
const tree_sitter_1 = __importDefault(__webpack_require__(17));
const TypeScript = (__webpack_require__(22).typescript);
const JavaScript = __webpack_require__(25);
...
const binding = __webpack_require__(18)(__dirname);
...
module.exports = __webpack_require__(18)(root);

try {
  module.exports.typescript.nodeTypeInfo = __webpack_require__(23);
  module.exports.tsx.nodeTypeInfo = __webpack_require__(24);
} catch (_) { }
...
try {
  module.exports.nodeTypeInfo = __webpack_require__(26);
} catch (_) {}
