...
const ModelClient_1 = __webpack_require__(5);
function activate(context) {
    ...
    async function handleAIMessage(payload) {
        ...
        try {
            ...
            // Send to AI
            const response = await modelClient.sendMessage({ provider, modelId, apiKey }, messagesWithContext);
            // Save chat history
    ...
    async function applyCodeToFile(code, filePath) {
        try {
...
const GroqClient_1 = __webpack_require__(6);
const GoogleClient_1 = __webpack_require__(8);
const OpenAIClient_1 = __webpack_require__(9);
class ModelClient {
    constructor() {
    ...
    setAPIKey(provider, apiKey) {
        switch (provider.toLowerCase()) {
            ...
            case 'deepseek':
            case 'sambanova':
                this.clients.set(provider.toLowerCase(), new OpenAIClient_1.OpenAIClient(apiKey, provider.toLowerCase()));
                break;
        }
    }
...
const BaseAPIClient_1 = __webpack_require__(7);
